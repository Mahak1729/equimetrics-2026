...
export const forecastRaces = [
  ...
  },
  {
    ...
    paceAnalysis: {
      ...
      scenario: 'honest',
      label: 'Honest Pace',
      detail: 'Three front-runners (Highland Storm, Autumn Rally, Celtic Wind) will push the pace on turf, but none are dominant enough to get clear. The honest fractions should let the best horse prevail, so look for tactical horses with both speed and stamina.',
    },
    gpsEdgePicks: [
      {
        name: 'Coastal Breeze',
